      ...
      <Grid container direction="column" style={{ minHeight: '700px' }}>
        <Hidden xsDown>
          <Grid item container className="mb-1 p-1">
            <Grid item xs={1} container justify="center">Rank</Grid>
            <Grid item xs container justify="center">Relayers</Grid>
            <Grid item xs container justify="center">Fee 24h($)</Grid>
            <Grid item xs container justify="center">Trades(24h)</Grid>
            <Grid item xs container justify="center">Volumes($)</Grid>
          </Grid>
        </Hidden>
