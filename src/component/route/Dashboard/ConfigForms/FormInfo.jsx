          ...
          <Grid item container spacing={6} direction="column">
            ...
            <Grid item>
              <Typography component="div" variant="body2" style={{ lineHeight: 1.5 }}>
                Read more <StyledLink href="https://medium.com/tomochain/tomox-relayer-support-program-55589bc5e0f2" target="_blank"><b>TomoX Relayer Support Program</b></StyledLink>
              </Typography>
            </Grid>
            ...
            <Grid item>
              <Typography component="div" variant="body2" style={{ lineHeight: 1.5 }}>
                If you want to run the DEX on your server using TomoX-SDK, follow this <StyledLink href="https://docs.tomochain.com/masternode/tomox-sdk/" rel="noopener noreferrer" target="_blank">link</StyledLink> for detailed instructions.<br />
